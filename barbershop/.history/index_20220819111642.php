		    ...
		    <div id="home-section-carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="Design/images/as.jpg" alt="First slide" height = "759.5px" width = "100%">
                    ...
                    <!-- THIRD SLIDE -->
                    <div class="carousel-item">
                        <img class="d-block w-100" src="Design/images/barbershop_image.jpg" alt="Third slide" height = "759.5px" width = "100%">
                        <div class="carousel-caption d-md-block">
                            <h3>It's Not Just a Haircut, It's an Experience.</h3>
                            <p>
                                Our barbershop is the territory created purely for males who appreciate
    ...
    <section class="gallery-section" id="gallery">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 gallery-column">
                    <div style="height: 230px">
                        <div class="gallery-img" style="background-image: url('Design/images/Gallery_06.jpg');"></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 gallery-column">
                    <div style="height: 230px">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="widget_social">
                            ...
                            <li><a href="#" data-toggle="tooltip" title="Viber"><i class="fab fa-viber fa-2x"></i></a></li>
