        ...
        <div class="container">
            <div id="reviews-carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <!-- REVIEW 1 -->
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="Design/images/testimonial.jpg" alt="First slide" style="visibility: hidden;">
                        <div class="carousel-caption d-md-block">
                                            ...
                                            foreach($services as $service)
                                            {
                                                ?>
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="price" style="position: relative; left: 250px; bottom: 100px"><b>RS.<?php echo $service['service_price'] ?></b></span>
                                                    </li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <img src="Design/images/logo.png" alt="Brand" length = "80px" height = "80px">
                        <p>
                        Welcome to Pariwar
                        <br>
