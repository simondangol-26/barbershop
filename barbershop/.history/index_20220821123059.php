        ...
        <div class="container">
            <div id="reviews-carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <!-- REVIEW 1 -->
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="Design/images/cutting.jpg" alt="First slide">
                        <div class="carousel-caption d-md-block">
                    ...
                    <!-- REVIEW 2 -->
                    <div class="carousel-item">
                        <img class="d-block w-100" src="Design/images/cutting.jpg" alt="Second slide">
                        <div class="carousel-caption d-md-block">
                    ...
                    <!-- REVIEW 3 -->
                    <div class="carousel-item">
                        <img class="d-block w-100" src="Design/images/cutting.jpg" alt="Third slide">
                        <div class="carousel-caption d-md-block">
                            <h3>Your<br>
                                Hair is<br>
                                90% of your<br>
